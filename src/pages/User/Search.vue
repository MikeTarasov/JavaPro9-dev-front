...
import SearchAll from 'src/components/Search/All'
import SearchUsers from 'src/components/Search/Users'
import SearchNews from 'src/components/Search/News'
import SearchFilterUsers from 'src/components/Search/Filter/Users'
import SearchFilterNews from 'src/components/Search/Filter/News'
export default {
  name: 'Search',
