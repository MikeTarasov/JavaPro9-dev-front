<template lang="pug">
  .admin-users.inner-page.admin
    h2.admin__title Люди
    .admin__wrap
      .inner-page__main
        .admin__search
          admin-search(v-model="search" @change-value="onChangeSearch")
        .friends__list
          friends-block(admin)
...
import FriendsBlock from 'src/components/Friends/Block'
export default {
  name: 'AdminUsers',
